...
const originalEnv = {
  ...
  TELEGRAM_CLI_DATA_DIR: process.env.TELEGRAM_CLI_DATA_DIR,
}

beforeEach(() => {
  mkdirSync(tempDir, { recursive: true })
  rmSync(pidPath, { force: true })
  process.env.TELEGRAM_CLI_DATA_DIR = tempDir
})
...
afterEach(() => {
  ...
  process.env.TELEGRAM_CLI_DATA_DIR = originalEnv.TELEGRAM_CLI_DATA_DIR
})
